"""
Report rendering for the payroll & benefit reconciliation engine.
=================================================================
...
TITLE = "Payroll & benefit reconciliation control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Reconciliation files analyzed: {len(reports)}",
