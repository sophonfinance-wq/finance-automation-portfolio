...
from benefit_engine.generate import generate_corpus
from benefit_engine.report import build_json_report, build_markdown_report
...
def test_empty_file_does_not_crash(tmp_path: Path) -> None:
    """A reconciliation file with no documents fails loudly, not vacuously."""
