...
from benefit_engine.cli import main
from benefit_engine.engine import REGISTRY, analyze_folder
from benefit_engine.model import DocumentReport, Status, Verdict
from benefit_engine.report import (
    build_json_report,
...
def test_markdown_report_has_structure(reports: list[DocumentReport]) -> None:
    ...
    assert "## Reconciliation files" in md
    assert md.endswith("\n")
