"""
Money primitives for the payroll & benefit reconciliation engine.
=================================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. A deferral
withheld from an employee has to arrive at the recordkeeper, the custodian, the
ledger and cash in the same amount, and a penny of tolerance at any of those
stops is a penny of somebody's retirement money unaccounted for. Statutory
ceilings are compared the same way: 402(g) and 415(c) are limits, not targets,
and a plan is either inside one or it is not.
