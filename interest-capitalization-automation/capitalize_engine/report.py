"""
Report rendering for the Section 263A interest-capitalization engine.
=====================================================================
...
TITLE = "Section 263A interest-capitalization control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Capitalization files analyzed: {len(reports)}",
