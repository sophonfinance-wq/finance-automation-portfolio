...
from capitalize_engine.cli import main
from capitalize_engine.engine import REGISTRY, analyze_folder
from capitalize_engine.model import DocumentReport, Status, Verdict
from capitalize_engine.report import (
    build_json_report,
...
def test_markdown_report_has_structure(reports: list[DocumentReport]) -> None:
    ...
    assert "## Capitalization files" in md
    assert md.endswith("\n")
