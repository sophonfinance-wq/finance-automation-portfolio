"""
Money primitives for the Section 263A interest capitalization engine.
=====================================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. Interest is
either capitalized into basis or deducted in the year paid, and the two have to
exhaust the interest incurred: a penny of tolerance is a penny that was neither,
which is the leak this engine exists to find. Quarterly figures have to foot to
their annual total exactly, because the annual total is what reaches the return.
