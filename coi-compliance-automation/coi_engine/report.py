"""
Report rendering for the Insurance compliance engine.
=====================================================
...
TITLE = "Insurance compliance control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Compliance files analyzed: {len(reports)}",
