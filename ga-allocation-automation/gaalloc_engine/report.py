"""
Report rendering for the G&A allocation engine.
===============================================
...
TITLE = "G&A expense allocation control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Allocation files analyzed: {len(reports)}",
