"""
Command-line interface for the surety bond & collateral engine.
===============================================================
...
::
    ...
    python -m bond_engine <folder> [options]
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        prog="python -m bond_engine",
        description=(
            "Read-only control engine for a developer's surety bond programme: "
            "bond lifecycle, collateral recovery, premium and aggregate exposure. "
            "Analyzes seeded, fictional programme files."
        ),
    )
