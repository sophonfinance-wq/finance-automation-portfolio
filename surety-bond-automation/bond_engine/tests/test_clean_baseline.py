...
from bond_engine.engine import REGISTRY, SEVERITY, analyze_document
from bond_engine.model import DocumentReport, Status, Verdict
...
def test_every_rule_declares_a_severity(clean_report: DocumentReport) -> None:
    ...
    :func:`~bond_engine.engine.amount_invalid_finding` and would silently
    default to FAIL.
    """
