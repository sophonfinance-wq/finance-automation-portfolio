"""
Report rendering for the information-return issuance engine.
===========================================================
...
TITLE = "Information-return issuance control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Reporting files analyzed: {len(reports)}",
