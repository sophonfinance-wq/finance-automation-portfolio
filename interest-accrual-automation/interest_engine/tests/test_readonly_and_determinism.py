...
from interest_engine.generate import generate_corpus
from interest_engine.report import build_json_report, build_markdown_report
...
def test_empty_file_does_not_crash(tmp_path: Path) -> None:
    """A loan file with no documents fails loudly rather than passing vacuously."""
