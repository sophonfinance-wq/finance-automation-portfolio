"""
Report rendering for the interest-accrual & loan-amortization engine.
=====================================================================
...
TITLE = "Interest accrual & loan amortization control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Loan files analyzed: {len(reports)}",
