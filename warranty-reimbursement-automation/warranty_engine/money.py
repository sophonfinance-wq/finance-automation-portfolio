"""
Money primitives for the warranty reimbursement engine.
=======================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. A claim total that
tolerates a penny has not been reconciled to the costs behind it.
...
class AmountInvalidError(ValueError):
    ...
    field:
        Dotted path of the offending field, e.g. ``"CLM-2028-Q2/requested"``.
    value:
