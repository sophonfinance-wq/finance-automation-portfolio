...
Order matters and is fixed: journal entries first (no vendor exists), then
clearing accounts, then wrap enrollment, then category exemptions, then live
coverage, then chase. Every line lands in exactly one bucket.
"""
