"""
Report rendering for the lien waiver tracking engine.
=====================================================
...
TITLE = "Lien waiver coverage control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Portfolio files analyzed: {len(reports)}",
