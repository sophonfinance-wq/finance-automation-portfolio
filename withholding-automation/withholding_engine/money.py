"""
Money primitives for the non-resident withholding & 1042-S engine.
==================================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. Deposits equal
the liability or the withholding agent is short, and Form 1042 ties to the slips
it transmits or it reports a total the slips do not support -- and the payee
claims a credit against the slip, not against the return. Every rate is applied
as integer basis points with truncating division, so the tax withheld and the
tax the payee's status calls for are compared exactly.
