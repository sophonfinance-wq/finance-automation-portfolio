"""
Report rendering for the non-resident withholding engine.
=========================================================
...
TITLE = "Non-resident withholding & 1042-S control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Withholding files analyzed: {len(reports)}",
