"""
Report rendering for the depreciation & prepaid amortization engine.
====================================================================
...
TITLE = "Depreciation & prepaid amortization control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Close files analyzed: {len(reports)}",
