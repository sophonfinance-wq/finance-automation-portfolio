"""
Command-line interface for the intercompany reciprocity engine.
===============================================================
...
::
    ...
    python -m intercompany_engine <folder> [options]
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        prog="python -m intercompany_engine",
        description=(
            "Read-only control engine for intercompany reciprocity and the "
            "cash-flow funding protocol. Analyzes seeded, fictional period files."
        ),
    )
