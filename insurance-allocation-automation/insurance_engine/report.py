"""
Report rendering for the Insurance cost allocation engine.
=========================================================
...
TITLE = "Insurance cost allocation control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Programme files analyzed: {len(reports)}",
