...
from insurance_engine.generate import generate_corpus
from insurance_engine.report import build_json_report, build_markdown_report
...
def test_empty_package_does_not_crash(tmp_path: Path) -> None:
    """A programme file with no documents fails loudly rather than passing vacuously."""
