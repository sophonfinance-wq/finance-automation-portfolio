"""
Report rendering for the project-proforma integrity engine.
===========================================================
...
TITLE = "Project-proforma integrity control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Proforma files analyzed: {len(reports)}",
