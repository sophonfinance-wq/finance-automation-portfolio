"""
Money primitives for the entity good-standing engine.
=====================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. A flat statutory
fee has one correct amount, and an entity that pays a dollar short of it is not
in good standing however nearly it paid. Most determinations here are dates,
statuses and named agents; the money that does appear is compared whole, against
the amount the jurisdiction names.
