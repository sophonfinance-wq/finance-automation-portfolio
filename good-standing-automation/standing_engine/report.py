"""
Report rendering for the entity good-standing engine.
=====================================================
...
TITLE = "Entity good-standing control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Standing files analyzed: {len(reports)}",
