"""
Report rendering for the Financing Execution & Schedule-Variance engine.
========================================================================
...
TITLE = "Financing execution & schedule-variance control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Financing reports analyzed: {len(reports)}",
