...
from financing_engine.generate import generate_corpus
from financing_engine.report import build_json_report, build_markdown_report
...
def test_empty_report_does_not_crash(tmp_path: Path) -> None:
    """A financing report with no documents fails loudly rather than passing vacuously."""
