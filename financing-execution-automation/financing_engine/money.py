"""
Money primitives for the financing execution engine.
====================================================
...
reconciles dates, day-count variances and rollup counts more often than dollars,
and the same rule governs them: a variance is the difference between two dates
or it is a number somebody typed. The deal sizes the pipeline report carries are
held as integer cents for the same reason -- so this month's ``Prior`` column
can be proved equal to last month's ``Current``.
