...
from waterfall_engine.generate import generate_corpus
from waterfall_engine.report import build_json_report, build_markdown_report
...
def test_empty_deal_does_not_crash(tmp_path: Path) -> None:
    """A deal file with no documents fails loudly rather than passing vacuously."""
