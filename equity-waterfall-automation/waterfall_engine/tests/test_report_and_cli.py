...
from waterfall_engine.cli import main
from waterfall_engine.engine import REGISTRY, analyze_folder
from waterfall_engine.model import DocumentReport, Status, Verdict
from waterfall_engine.report import (
    build_json_report,
...
def test_markdown_lists_every_deal(reports: list[DocumentReport]) -> None:
    md = build_markdown_report(reports)
    for report in reports:
