#!/usr/bin/env python3
"""
One-command demo of the equity-waterfall engine.
================================================
...
from waterfall_engine.cli import main  # noqa: E402
...
if __name__ == "__main__":
    raise SystemExit(
        main([
            str(HERE / "samples"),
            "--generate",
            "--json", str(HERE / "waterfall_report.json"),
            "--md", str(HERE / "waterfall_report.md"),
        ])
    )
