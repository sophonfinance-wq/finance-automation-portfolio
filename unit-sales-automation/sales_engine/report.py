"""
Report rendering for the Unit sales and commission tie-out engine.
==================================================================
...
TITLE = "Unit sales and commission tie-out control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Sales files analyzed: {len(reports)}",
