"""
Report rendering for the combined-group franchise-tax engine.
=============================================================
...
TITLE = "Combined-group franchise-tax control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Combined-return files analyzed: {len(reports)}",
