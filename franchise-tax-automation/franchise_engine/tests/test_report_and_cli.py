...
from franchise_engine.cli import main
from franchise_engine.engine import REGISTRY, analyze_folder
from franchise_engine.model import DocumentReport, Status, Verdict
from franchise_engine.report import (
    build_json_report,
...
def test_markdown_report_has_structure(reports: list[DocumentReport]) -> None:
    ...
    assert "## Combined-return files" in md
    assert md.endswith("\n")
