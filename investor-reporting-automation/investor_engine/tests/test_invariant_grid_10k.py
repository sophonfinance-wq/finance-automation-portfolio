...
from investor_engine.money import allocate_by_ratio, apply_rate, split_evenly
...
# The first shape is the sharing ratio the shipped capital statement discloses,
# so the Total column's cross-foot identity is swept as itself.
# --------------------------------------------------------------------------- #
_WEIGHT_SHAPES: tuple[tuple[int, ...], ...] = ((2000, 8000), (2500, 2500, 5000))
