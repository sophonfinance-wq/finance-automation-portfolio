...
from pickup_engine.cli import main
from pickup_engine.engine import REGISTRY, analyze_folder
from pickup_engine.model import DocumentReport, Status, Verdict
from pickup_engine.report import (
    build_json_report,
...
def test_markdown_report_has_structure(reports: list[DocumentReport]) -> None:
    ...
    assert "## Consolidation files" in md
    assert md.endswith("\n")
