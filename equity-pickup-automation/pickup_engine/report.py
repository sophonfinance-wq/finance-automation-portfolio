"""
Report rendering for the equity-pickup control engine.
======================================================
...
TITLE = "Equity-method pickup & eliminations control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Consolidation files analyzed: {len(reports)}",
