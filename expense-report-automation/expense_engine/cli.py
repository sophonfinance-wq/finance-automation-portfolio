"""
Command-line interface for the Expense & P-Card control engine.
==============================================================
...
::
    ...
    python -m expense_engine <folder> [options]
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        prog="python -m expense_engine",
        description=(
            "Read-only control engine for employee expense reports and company-card (P-Card) spending: every statement charge reconciled to a receipted, coded, approved report line. Analyzes seeded, fictional cycle files."
        ),
    )
