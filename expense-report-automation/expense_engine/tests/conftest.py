"""Shared fixtures for the expense & P-Card control engine test suite.
...
from expense_engine.engine import analyze_document, analyze_folder
from expense_engine.generate import DEFECTS, generate_corpus
from expense_engine.model import DocumentReport


@pytest.fixture(scope="session")
def corpus(tmp_path_factory: pytest.TempPathFactory) -> Path:
    """A freshly generated corpus in a temporary directory."""
    folder = tmp_path_factory.mktemp("cycle_corpus")
