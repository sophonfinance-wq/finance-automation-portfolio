...
## Tools
`Python (openpyxl)` · `LibreOffice headless recalc` · `Excel` · `Sage GL (Office Connector)` · `Bank of Canada FX` · `Claude Code` · `ChatGPT` · `Codex` · `NotebookLM`
...
├── tests/               # pytest suite (1,486 tests)
