"""
Command-line interface for the gross-receipts & excise tax engine.
==================================================================
...
::
    ...
    python -m grt_engine <folder> [options]
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        prog="python -m grt_engine",
        description=(
            "Read-only control engine for a developer's gross-receipts & excise tax filings: every worksheet's tax re-derived from the GL revenue pull and the jurisdiction's rate table, tied to the number filed, with the filing calendar proved complete, timely and approved. Analyzes seeded, fictional reconciliation files."
        ),
    )
