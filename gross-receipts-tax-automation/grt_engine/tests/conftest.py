"""Shared fixtures for the gross-receipts & excise tax engine test suite.
...
from grt_engine.engine import analyze_document, analyze_folder
from grt_engine.generate import DEFECTS, generate_corpus
from grt_engine.model import DocumentReport


@pytest.fixture(scope="session")
def corpus(tmp_path_factory: pytest.TempPathFactory) -> Path:
    """A freshly generated corpus in a temporary directory."""
    folder = tmp_path_factory.mktemp("recon_corpus")
