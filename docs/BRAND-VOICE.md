...
- Every claim is true and demonstrable. Current facts: **seven runnable systems, a ~10,000-test curated suite (plus an opt-in ~1.1M-case property/invariant sweep), fully
