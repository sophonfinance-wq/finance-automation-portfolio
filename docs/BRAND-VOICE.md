...
- Every claim is true and demonstrable. Current facts: **eight runnable systems, a 24,740-test curated suite (plus an opt-in ~1.11M-case property/invariant sweep), fully
  fictional and seeded data, MIT-licensed, CI-backed.** (Verified via `pytest --collect-only` 2026-07-10.) Keep numbers current with the repository.
