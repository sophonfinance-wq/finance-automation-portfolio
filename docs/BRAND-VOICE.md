...
- Every claim is true and demonstrable. Current facts: **thirty-eight runnable systems, an 80,574-test curated suite (plus an opt-in ~1.26M-case property/invariant sweep), fully
