...
- Every claim is true and demonstrable. Current facts: **eight runnable systems, a 10,839-test curated suite (plus an opt-in ~1.1M-case property/invariant sweep), fully
  fictional and seeded data, MIT-licensed, CI-backed.** Keep numbers current with the repository.
