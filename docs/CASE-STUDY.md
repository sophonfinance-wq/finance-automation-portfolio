...
59,740-test curated suite (plus an opt-in ~1.15M-case property sweep), CI.**
...
| Multi-entity month-end close (recurring JEs, tie-outs, allocations) | `monthly-close-automation` | 13,053 |
