"""
Report rendering for the home-sale closing & settlement tie-out engine.
=======================================================================
...
TITLE = "Home-sale closing & settlement tie-out report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Closing files analyzed: {len(reports)}",
