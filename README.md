...
[![Tests](https://img.shields.io/badge/tests-24%2C740%20curated%20%C2%B7%20~1.11M%20sweep-2ea44f)](#testing)
...
**3. Honest, tiered tests.** `pytest` runs the curated suite (~25k, gates CI); `SWEEP=1 pytest` runs an exhaustive property sweep (~1.11M generated cases). See [Testing](#testing).
