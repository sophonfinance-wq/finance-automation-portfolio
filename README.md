...
outputs, continuous integration, and 10,000 tests that pin the behavior.
...
3. **Clone and run locally** — `pip install -r requirements.txt`, then `python -m pytest -q` (10,000 tests) or `bash scripts/demo.sh`.
