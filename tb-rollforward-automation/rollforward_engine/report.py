"""
Report rendering for the trial-balance roll-forward engine.
===========================================================
...
TITLE = "Trial-balance roll-forward control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Workpaper files analyzed: {len(reports)}",
