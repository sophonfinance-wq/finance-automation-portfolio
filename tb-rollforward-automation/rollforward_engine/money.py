"""
Money primitives for the trial-balance roll-forward engine.
===========================================================
...
that tolerates a penny against the trial balance beneath it reports a figure the
ledger does not support, and every downstream schedule inherits the drift. A
column that "approximately" sums to zero is a column hiding an unmapped account.
