...
from wire_engine.cli import main
from wire_engine.engine import REGISTRY, analyze_folder
from wire_engine.model import DocumentReport, Status, Verdict
from wire_engine.report import (
    build_json_report,
...
def test_markdown_report_has_structure(reports: list[DocumentReport]) -> None:
    ...
    assert "## Release-control files" in md
    assert md.endswith("\n")
