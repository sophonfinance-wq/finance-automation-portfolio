"""
Report rendering for the wire & transfer release-control engine.
================================================================
...
TITLE = "Wire & transfer release-control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Release-control files analyzed: {len(reports)}",
