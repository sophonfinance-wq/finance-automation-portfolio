...
from spending_engine.cli import main
from spending_engine.engine import REGISTRY, analyze_folder
from spending_engine.model import DocumentReport, Status, Verdict
from spending_engine.report import (
    build_json_report,
