"""
Report rendering for the capital spending request gate engine.
==============================================================
...
TITLE = "Capital spending request gate control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Request packages analyzed: {len(reports)}",
