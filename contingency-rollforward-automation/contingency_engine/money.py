"""
Money primitives for the contingency rollforward engine.
========================================================
...
Comparisons are exact ``==`` -- there is **no tolerance band**. A rollforward that
tolerates a penny has not rolled forward: the balance it reports no longer follows
from the period before it, and the drift compounds every period after. A bucket is
either reconciled to the budget that funded it to the cent or it is not reconciled
at all.
