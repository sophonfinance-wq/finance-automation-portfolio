"""Shared fixtures for the contingency rollforward engine test suite.
...
from contingency_engine.engine import analyze_document, analyze_folder
from contingency_engine.generate import DEFECTS, generate_corpus
from contingency_engine.model import DocumentReport


@pytest.fixture(scope="session")
def corpus(tmp_path_factory: pytest.TempPathFactory) -> Path:
    """A freshly generated corpus in a temporary directory."""
    folder = tmp_path_factory.mktemp("contingency_corpus")
