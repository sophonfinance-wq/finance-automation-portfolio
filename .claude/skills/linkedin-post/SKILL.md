---
name: linkedin-post
description: "Draft LinkedIn posts for Sophon Finance Systems in the founder's voice (hard opener, background for credit, non-AI style). Use for any social/announcement copy."
---
...
- Max 3 hashtags, lowercase: `#finance #accounting #ai`.
- **Links**: site (sophonfinance.com) + email (sophonfinance@gmail.com) in body; GitHub link works better as the FIRST COMMENT (body links get reach-throttled) — but follow the user's explicit ask if they want it in-body.
