...
from variance_engine.generate import generate_corpus
from variance_engine.report import build_json_report, build_markdown_report
...
def test_empty_package_does_not_crash(tmp_path: Path) -> None:
    """A project report with no documents fails loudly rather than passing vacuously."""
