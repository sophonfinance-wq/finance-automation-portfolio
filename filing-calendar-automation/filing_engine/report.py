"""
Report rendering for the Filing-obligation calendar engine.
===========================================================
...
TITLE = "Filing-obligation calendar control report"
...
def build_markdown_report(reports: list[DocumentReport]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        f"- Calendar files analyzed: {len(reports)}",
